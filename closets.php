...
<section>
	<div class="card bg-dark text-white text-center">
		...
		<div class="card-img-overlay separador-100">
			<h5 class="card-title display-4">Closets.</h5>
			<p class="lead">Closets a la medida, para guardar todas tus pertenencias de la manera más estética posible.</p>
		</div>
	</div>
											...
											<div class=\"col-sm-6\">
												...
												<tr>
													...
													<tr>
														...
														<td>
															<strong>Largo:</strong> ".$productos[$i]['largo']." metros<br />
												...
												<p class=\"text-right\">* Puede elegir la calidad. <br />** El precio estará sujeto a cambios.<br /><em>Ver <a href=\"\" target=\"_blank\">porqué varían los precios.</a></em></p>
											</div>
										</div>
									</div>
								</div>
