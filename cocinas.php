...
<section>
	<div class="card bg-dark text-white text-center">
		...
		<div class="card-img-overlay separador-100">
			<h5 class="card-title display-4">Cocinas.</h5>
			<p class="lead">Cocinas integrales, todo lo que necesitas y como siempre lo deseaste.</p>
		</div>
	</div>
									...
									<div class=\"container-fluid\">
										<div class=\"row\">
											...
											<div class=\"col-sm-6\">
												...
												<tr>
													<th scope=\"row\">SKU:</th>
													<td name=\"productos[id_producto]\">".$productos[$i]['id_producto']."</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<tr>
														...
														<td>Sí (Cubierta de aglomerado)*</td>
													</tr>
													<tr>
												...
												<p class=\"text-right\">* Podrá ser reemplazada pero afectará al precio. <br />** El precio estará sujeto a cambios.<br /><em>Ver <a href=\"\" target=\"_blank\">porqué varían los precios.</a></em></p>
											</div>
										</div>
									</div>
								</div>
